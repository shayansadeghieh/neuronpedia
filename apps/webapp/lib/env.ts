...
export const GRAPH_SERVER_QWEN3_4B = process.env.GRAPH_SERVER_QWEN3_4B || '';
...
export const GRAPH_RUNPOD_SERVER_QWEN3_4B = process.env.GRAPH_RUNPOD_SERVER_QWEN3_4B || '';
